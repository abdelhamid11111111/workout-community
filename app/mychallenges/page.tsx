...
const MyChallenges = () => {
  const userActiveChallenges: OldChallenge[] = [
    {
      id: 1,
  ...
  const completedChallenges: OldChallenge[] = [
    {
      id: 4,
    ...
    <div className="min-h-screen bg-slate-50 antialiased">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-10 lg:py-16">
        ...
        <div className="flex gap-3 mb-10 border-b border-slate-200 pb-4">
          <button className="px-6 py-3 rounded-xl font-semibold text-base bg-emerald-600 text-white shadow-md">
            Active ({userActiveChallenges.length})
          </button>
          <button className="px-6 py-3 rounded-xl font-semibold text-base bg-white text-slate-700 border border-slate-200 hover:bg-slate-50">
